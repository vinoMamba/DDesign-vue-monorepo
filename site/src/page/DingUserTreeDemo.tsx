...
import DingUserTree1 from '../demo-code/DingUserTree1.vue'

export const DingUserTreeDemo = defineComponent({
  name: 'DingUserTreeDemo',
  setup() {
    const demoList = ref<DemoType[]>([
      {
        codeVisible: false,
        title: '基础用法',
        component: shallowRef(DingUserTree1),
      },
    ])
